		...
		<div class="container-fluid">
			...
			<div class="navm">
				<ul>
					...
					<li><a style="background-color: #4CAF50;color: white" href="display.php">Display Result</a></li>
					...
					<table align="center" class="table-bordered table1">
						...
						<?php  
							...
							if ($flag==0) {
								...
								echo "<p id='ins'>Enter Session,Year and Semester of the students to see result</p>";
								echo '
										<tr>
